...
<body class="bg-slate-900 text-slate-100 overflow-x-hidden">
    ...
    <nav class="glass-morphism fixed top-0 w-full z-50 py-4 px-6">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8 space-x-reverse">
                <a href="#home" class="text-slate-300 hover:text-gold-300 transition-colors duration-300 font-medium">الرئيسية</a>
                <a href="#services" class="text-slate-300 hover:text-gold-300 transition-colors duration-300 font-medium">الخدمات</a>
                <a href="#consultations" class="text-slate-300 hover:text-gold-300 transition-colors duration-300 font-medium">الاستشارات</a>
                <a href="#dashboard" class="text-slate-300 hover:text-gold-300 transition-colors duration-300 font-medium">لوحة التحكم</a>
            </div>
            
            <!-- Login Button & Mobile Menu Toggle -->
            <div class="flex items-center space-x-4 space-x-reverse">
                <button class="hidden md:block px-6 py-2 border-2 border-emerald-500 text-emerald-400 hover:bg-emerald-500 hover:text-white rounded-full transition-all duration-300 font-medium">تسجيل الدخول</button>
        ...
        <div id="mobile-menu" class="md:hidden hidden mt-4 pb-4">
            <div class="flex flex-col space-y-4">
                <a href="#home" class="text-slate-300 hover:text-gold-300 transition-colors duration-300 font-medium py-2">الرئيسية</a>
                <a href="#services" class="text-slate-300 hover:text-gold-300 transition-colors duration-300 font-medium py-2">الخدمات</a>
                <a href="#consultations" class="text-slate-300 hover:text-gold-300 transition-colors duration-300 font-medium py-2">الاستشارات</a>
                <a href="#dashboard" class="text-slate-300 hover:text-gold-300 transition-colors duration-300 font-medium py-2">لوحة التحكم</a>
                <button class="px-6 py-2 border-2 border-emerald-500 text-emerald-400 hover:bg-emerald-500 hover:text-white rounded-full transition-all duration-300 font-medium w-fit">تسجيل الدخول</button>
            </div>
        </div>
    </nav>

    <!-- Hero Section -->
    <section id="home" class="pt-32 pb-20 px-6 bg-gradient-to-b from-slate-900 to-slate-800 relative overflow-hidden">
        <!-- Background Pattern -->
        <div class="absolute inset-0 opacity-10">
            <div class="absolute top-10 left-10 w-72 h-72 rounded-full bg-emerald-500 mix-blend-multiply filter blur-3xl opacity-20"></div>
            <div class="absolute bottom-10 right-10 w-72 h-72 rounded-full bg-gold-500 mix-blend-multiply filter blur-3xl opacity-20"></div>
        </div>
            ...
            <div class="flex flex-col lg:flex-row items-center">
                <div class="lg:w-1/2 mb-12 lg:mb-0">
                    ...
                    <p class="text-slate-300 text-lg mb-10 max-w-2xl">
                        نظام إدارة متكامل يوفر لك التحكم الكامل في مزرعتك من خلال تقنيات الذكاء الاصطناعي وإنترنت الأشياء. راقب أداء مزرعتك، زد إنتاجيتك، وقلل التكاليف من أي مكان وفي أي وقت.
                    </p>
                    <div class="flex flex-wrap gap-4">
                        <button class="gold-gradient text-slate-900 font-bold px-8 py-4 rounded-full hover:shadow-xl hover:shadow-gold-500/30 transition-all duration-300 text-lg">
                            ابدأ الآن <i class="fas fa-arrow-left mr-2"></i>
                        </button>
                        <button class="border-2 border-slate-500 text-slate-300 font-bold px-8 py-4 rounded-full hover:border-emerald-500 hover:text-emerald-400 transition-all duration-300 text-lg">
                            شاهد العرض التوضيحي
                        </button>
                    </div>
                </div>
                                ...
                                <div class="dashboard-grid mb-6">
                                    ...
                                    <div class="bg-slate-800 rounded-xl p-4">
                                        ...
                                        <div class="flex items-center justify-center h-32">
                                            <div class="relative">
                                                <div class="w-24 h-24 rounded-full border-8 border-emerald-500 border-r-transparent transform rotate-45"></div>
                                    ...
                                    <div class="bg-slate-800 rounded-xl p-4">
                                        ...
                                        <div class="flex items-center">
                                            <div class="w-12 h-12 rounded-full emerald-gradient flex items-center justify-center mr-3">
    ...
    <section id="services" class="py-20 px-6 bg-slate-800">
        <div class="container mx-auto">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold mb-4">حلول <span class="text-emerald-400">متكاملة</span> لإدارة <span class="text-gold-300">مزرعتك</span></h2>
                <p class="text-slate-300 text-lg max-w-3xl mx-auto">نقدم مجموعة من الحلول المتكاملة التي تساعدك على إدارة مزرعة الدواجن بكفاءة عالية باستخدام أحدث التقنيات</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-slate-900 rounded-2xl p-8 card-hover border border-slate-700">
                    ...
                    <p class="text-slate-300 mb-6">
                        نظام متكامل للتحكم الكامل في المزرعة مع تتبع في الوقت الفعلي، إدارة المخزون، وتحليل الأداء. احصل على تقارير مفصلة تساعدك على اتخاذ القرارات الصحيحة.
                    </p>
                    ...
                    <a href="#" class="text-emerald-400 font-medium hover:text-emerald-300 transition-colors duration-300">
                ...
                <div class="bg-slate-900 rounded-2xl p-8 card-hover border border-slate-700">
                    ...
                    <p class="text-slate-300 mb-6">
                        حلول متطورة تعتمد على إنترنت الأشياء للتحكم الدقيق في درجة الحرارة والرطوية والتهوية في المفقس لتحقيق أعلى معدلات الفقس والحفاظ على صحة الكتاكيت.
                    </p>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center text-slate-300">
                            <i class="fas fa-check-circle text-emerald-400 ml-3"></i>
                ...
                <div class="bg-slate-900 rounded-2xl p-8 card-hover border border-slate-700">
                    ...
                    <p class="text-slate-300 mb-6">
                        تواصل مع أفضل الخبراء البيطريين واستشاريي تربية الدواجن عبر منصتنا. احصل على نصائح مخصصة باستخدام الذكاء الاصطناعي لحل المشكلات وتحسين الإنتاجية.
                    </p>
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center text-slate-300">
                            <i class="fas fa-check-circle text-emerald-400 ml-3"></i>
        ...
        <div class="container mx-auto">
            <div class="flex flex-col lg:flex-row items-center">
                <div class="lg:w-1/2 mb-12 lg:mb-0 lg:pr-12">
                    <h2 class="text-4xl font-bold mb-6">لوحة تحكم <span class="text-gold-300">ذكية</span> تجعل إدارتك <span class="text-emerald-400">أسهل</span></h2>
                    <p class="text-slate-300 mb-8 text-lg">
                        تم تصميم لوحة التحكم الخاصة بنا لتوفير تجربة مستخدم فائقة تمكنك من مراقبة وإدارة كل جوانب مزرعتك من مكان واحد. بيانات حية، رسوم بيانية تفاعلية، وتقارير قابلة للتخصيص.
                    </p>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-300">احصل على تحديثات فورية عن أداء مزرعتك مع تنبيهات فورية لأي مشكلة محتملة.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-300">استخدم أدوات التحليل المتقدمة لفهم اتجاهات الإنتاجية وتحسين عمليات المزرعة.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-slate-300">ادخل إلى نظامك من أي جهاز - كمبيوتر، لوحي، أو هاتف ذكي - مع تجربة مستخدم متكاملة.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="consultations" class="py-20 px-6 bg-slate-800">
        <div class="container mx-auto">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold mb-4">استشارات <span class="text-emerald-400">متخصصة</span> لتحقيق <span class="text-gold-300">أفضل النتائج</span></h2>
                <p class="text-slate-300 text-lg max-w-3xl mx-auto">تواصل مع أفضل الخبراء والمستشارين في مجال تربية الدواجن للحصول على إرشادات مخصصة تساعدك على تحقيق أقصى إنتاجية</p>
            </div>
            ...
            <div class="max-w-4xl mx-auto bg-slate-900 rounded-2xl p-8 border border-slate-700">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/3 mb-8 md:mb-0">
                        <div class="relative">
                            <div class="w-64 h-64 rounded-full emerald-gradient mx-auto flex items-center justify-center">
                                <i class="fas fa-headset text-white text-7xl"></i>
                            </div>
                            <div class="absolute -bottom-2 -right-2 w-20 h-20 rounded-full gold-gradient flex items-center justify-center">
                    ...
                    <div class="md:w-2/3 md:pr-8">
                        <h3 class="text-3xl font-bold mb-6">تواصل مع الخبراء <span class="text-emerald-400">الآن</span></h3>
                        <p class="text-slate-300 mb-6 text-lg">
                            من خلال منصتنا، يمكنك الوصول إلى شبكة من الخبراء البيطريين والمتخصصين في تربية الدواجن. سواء كنت بحاجة إلى استشارة سريعة أو خطة إدارة شاملة، فريقنا جاهز لمساعدتك.
                        </p>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div class="flex items-center">
                                <div class="w-10 h-10 rounded-full bg-emerald-900/30 flex items-center justify-center mr-3">
                                    <i class="fas fa-video text-emerald-400"></i>
                                </div>
                                <span class="text-slate-300">استشارات فيديو مباشرة</span>
                            </div>
                            <div class="flex items-center">
                                <div class="w-10 h-10 rounded-full bg-gold-900/30 flex items-center justify-center mr-3">
                        ...
                        <button class="gold-gradient text-slate-900 font-bold px-8 py-3 rounded-full hover:shadow-xl hover:shadow-gold-500/30 transition-all duration-300 text-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                <div>
                    ...
                    <p class="text-slate-400 mb-6">
                        نظام إدارة مزارع الدواجن الرائد في المنطقة، يوفر حلولاً تقنية متكاملة لتحسين إنتاجية المزارع وزيادة أرباحها.
                    </p>
                    <div class="flex space-x-4 space-x-reverse">
                        <a href="#" class="w-10 h-10 rounded-full bg-slate-800 hover:bg-emerald-500 flex items-center justify-center text-slate-300 hover:text-white transition-colors duration-300">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#home" class="text-slate-400 hover:text-emerald-400 transition-colors duration-300">الرئيسية</a></li>
                        <li><a href="#services" class="text-slate-400 hover:text-emerald-400 transition-colors duration-300">الخدمات</a></li>
                        <li><a href="#consultations" class="text-slate-400 hover:text-emerald-400 transition-colors duration-300">الاستشارات</a></li>
                        <li><a href="#dashboard" class="text-slate-400 hover:text-emerald-400 transition-colors duration-300">لوحة التحكم</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-slate-400 hover:text-emerald-400 transition-colors duration-300">إدارة المزرعة</a></li>
                        <li><a href="#" class="text-slate-400 hover:text-emerald-400 transition-colors duration-300">التحكم في المفقس</a></li>
                        <li><a href="#" class="text-slate-400 hover:text-emerald-400 transition-colors duration-300">استشارات الخبراء</a></li>
                        <li><a href="#" class="text-slate-400 hover:text-emerald-400 transition-colors duration-300">التقارير والتحليلات</a></li>
                    </ul>
                </div>
